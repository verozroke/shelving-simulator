...
export const useDishCareStore = defineStore('dishCareStore', {
    state: () => ({
        ...
        imgs: [
            ...
            {id: 66, src: './categories/dishCare/66.png', isWide: false},
            {id: 67, src: './categories/dishCare/67.png', isWide: false},
            {id: 68, src: './categories/dishCare/68.png', isWide: false},
            {id: 69, src: './categories/dishCare/69.png', isWide: false},
        ]
    })
})  